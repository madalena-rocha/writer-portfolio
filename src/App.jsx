  ...
  const booksData = [
    {
      ...
      description: [
        "A trajetória de Mariana nunca foi fácil. Conflitos familiares, problemas emocionais e dificuldades financeiras sempre fizeram parte do seu dia a dia.",
  ...
  const talesData = [
    {
      ...
      title: "Maldição",
      description: [
        "Apesar de saber a gravidade do seu crime, Zezão achou que tudo ficaria bem quando sua prima Yane, persuadida pelos próprios familiares, retirou a acusação que pesava sobre ele e Berto, seu amigo.",
    ...
    },
    {
      ...
      description: [
        "A Revista Literatura Fantástica é um projeto periódico pulp, sendo esta sua primeira edição.",
